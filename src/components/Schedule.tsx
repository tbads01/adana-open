    ...
    <section id="schedule" className="bg-paper py-24 text-ink md:py-32">
      <div className="section-pad mx-auto max-w-[1400px]">
          ...
          <div className="flex snap-x snap-mandatory gap-3 overflow-x-auto px-2 pb-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {s.days.map((day, i) => (
              <article
                ...
                className="flex min-h-[30.5rem] w-[min(78vw,16.5rem)] shrink-0 snap-start flex-col overflow-hidden rounded-[1.35rem] bg-white shadow-[0_18px_40px_rgba(26,39,81,0.08)]"
              >
        ...
        <Reveal className="mt-16">
          <div id="match-plan" className="overflow-hidden rounded-[1.6rem] bg-ink text-paper">
                ...
                {MATCH_PLAN.map((day, i) => {
                  ...
                  return (
                    <article
                      key={day.dateKey}
                      id={`msp-${day.dateKey}`}
                      className="overflow-hidden rounded-[1.2rem] bg-panel"
                    >
